...
pro plot_sed, galaxy
 ...
 ;xtitle14=TeXtoIDL('\xi_W^{tot}') & xrange14=[0.01,0.99]
  ...
  ENDIF
  xyouts,positionU1[0]+0.04*(positionU1[1]-positionU1[0]),positionU1[3]-1*0.04*(positionU1[3]-positionU1[1]),/NORMAL,name_xy,charthick=3,charsize=1.25, align=0 ; legend
  xyouts,positionU1[0]+0.04*(positionU1[1]-positionU1[0]),positionU1[3]-2*0.04*(positionU1[3]-positionU1[1]),/NORMAL,TeXtoIDL("z=")+STRTRIM(STRING(z,FORMAT='(F0.4)'),2),charthick=3,charsize=1.25, align=0
  xyouts,positionU1[0]+0.04*(positionU1[1]-positionU1[0]),positionU1[3]-3*0.04*(positionU1[3]-positionU1[1]),/NORMAL,TeXtoIDL("\chi^{2}=")+STRTRIM(STRING(chi2,FORMAT='(G10)'),2),charthick=3,charsize=1.25, align=0
