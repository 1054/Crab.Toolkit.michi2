...
pro plot_sed, galaxy
  ...
  plot,Mdust[0,*],Mdust[1,*],psym=10,xrange=xrange10,xtitle=xtitle10,xstyle=1,thick=5,xthick=3,ythick=3,xticklen=0.1,xminor=5,ystyle=1,yrange=[0,1.18],charthick=3,charsize=1.5,xcharsize=0.9,POSITION=position08,YTICKFORMAT="(A1)"
  xyouts, (position08[0]+position08[3])/2.0, (position08[1]-0.01), xtitle10, /NORMAL, ALIGNMENT=0.5, CHARSIZE=1.5
