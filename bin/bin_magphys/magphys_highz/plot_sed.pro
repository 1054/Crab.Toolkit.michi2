...
pro plot_sed, galaxy
 ...
 ;xtitle14=TeXtoIDL('\xi_W^{tot}') & xrange14=[0.01,0.99]
  ...
  ; Histograms 
  plot,Mstars[0,*],Mstars[1,*],           psym=10,xrange=xrange01,xstyle=1,thick=5,xthick=3,ythick=3,xticklen=0.1,xtickinterval=xtickinterval01,xminor=5,ystyle=1,yrange=[0,1.18],charthick=3,charsize=1.5,xcharsize=0.9,POSITION=position01
