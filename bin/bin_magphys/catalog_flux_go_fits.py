...
def recognize_Filter(input_str, second_str=''):
    ...
    if type(input_str) is str:
        ...
        # 
        # Match filters
        if input_str == 'FLUX_GALEX_NUV' or input_str == 'FLUXERR_GALEX_NUV' or input_str == 'GALEX NUV': 
            Filter_Name = 'GALEX NUV'
            Filter_Wave = 2313.9 * 1e-4 # um, Laigle 2016 Table 1
        elif input_str == 'FLUX_GALEX_FUV' or input_str == 'FLUXERR_GALEX_FUV' or input_str == 'GALEX FUV': 
            Filter_Name = 'GALEX FUV'
            Filter_Wave = 1529. * 1e-4 # um, http://galex.stsci.edu/gr6/?page=faq
        # 
        ...
        # 
        elif input_str == 'FLUX_435W' or input_str == 'FLUXERR_435W' or input_str == 'F435W' or input_str == 'f_f435w' or input_str == 'df_f435w' or input_str == 'e_f435w': 
            Filter_Name = 'HST ACS'
            Filter_Wave = 0.435 # um
        elif input_str == 'FLUX_606W' or input_str == 'FLUXERR_606W' or input_str == 'F606W' or input_str == 'f_f606w' or input_str == 'df_f606w' or input_str == 'e_f606w': 
            Filter_Name = 'HST ACS'
            Filter_Wave = 0.606 # um
        elif input_str == 'FLUX_775W' or input_str == 'FLUXERR_775W' or input_str == 'F775W' or input_str == 'f_f775w' or input_str == 'df_f775w' or input_str == 'e_f775w': 
            Filter_Name = 'HST ACS'
            Filter_Wave = 0.775 # um
        elif input_str == 'FLUX_814W' or input_str == 'FLUXERR_814W' or input_str == 'F814W' or input_str == 'f_f814w' or input_str == 'df_f814w' or input_str == 'e_f814w': 
            Filter_Name = 'HST ACS'
            Filter_Wave = 0.814 # um
        elif input_str == 'FLUX_850W' or input_str == 'FLUXERR_850W' or input_str == 'F850W' or input_str == 'f_f850lp' or input_str == 'df_f850lp' or input_str == 'e_f850lp': 
            Filter_Name = 'HST ACS'
            Filter_Wave = 0.850 # um
        elif input_str == 'FLUX_125W' or input_str == 'FLUXERR_125W' or input_str == 'F125W' or input_str == 'f_f125w' or input_str == 'df_f125w' or input_str == 'e_f125w': 
            Filter_Name = 'HST WFC3'
            Filter_Wave = 1.25 # um
        elif input_str == 'FLUX_140W' or input_str == 'FLUXERR_140W' or input_str == 'F140W' or input_str == 'f_f140w' or input_str == 'df_f140w' or input_str == 'e_f140w': 
            Filter_Name = 'HST WFC3'
            Filter_Wave = 1.40 # um
        elif input_str == 'FLUX_160W' or input_str == 'FLUXERR_160W' or input_str == 'F160W' or input_str == 'f_f160w' or input_str == 'df_f160w' or input_str == 'e_f160w': 
            Filter_Name = 'HST WFC3'
            Filter_Wave = 1.60 # um
        # 
        elif input_str == 'f_irac1' or input_str == 'df_irac1' or input_str == 'e_irac1': 
            Filter_Name = 'Spitzer IRAC'
...
if len(sys.argv) > 1:
    ...
    for TableHeader in TableData.getColumnNames():
        ...
        if Pattern_SOU.match(TableHeader):
            SOU.append(TableHeader)
        Pattern_SOU = re.compile("[^A-Z]*(NUMBER)[^A-Z]*")
        if Pattern_SOU.match(TableHeader):
            SOU.append(TableHeader)
        ...
        if TableHeader.upper().startswith('FLUX_') or TableHeader.upper().endswith('_FLUX'): 
            if TableHeader.upper().startswith('FLUX_RADIUS'):
                ...
                SED.append({'Type':'FLUX uJy', 'Head':TableHeader, 'Band':TableHeader.replace('FLUX_',''), 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'uJy'})
                continue
            else:
                SED.append({'Type':'FLUX mJy', 'Head':TableHeader, 'Band':TableHeader.replace('FLUX_',''), 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'mJy'})
                continue
        ...
        if TableHeader.upper().startswith('FLUXERR_') or TableHeader.upper().endswith('_FLUX_ERR'): 
            if TableHeader.upper().startswith('FLUXERR_RADIUS'):
                ...
                SED.append({'Type':'FLUX ERROR uJy', 'Head':TableHeader, 'Band':TableHeader.replace('FLUXERR_',''), 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'uJy'})
                continue
            else:
                SED.append({'Type':'FLUX ERROR mJy', 'Head':TableHeader, 'Band':TableHeader.replace('FLUXERR_',''), 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'mJy'})
                continue
        # 
        # COSMOS2015 catalog columns
        if TableHeader == 'ACS_F814W':
            SED.append({'Type':'MAG AB', 'Head':TableHeader, 'Band':'F814W', 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'AB'})
            continue
        if TableHeader == 'dF814W':
            SED.append({'Type':'MAG ERROR', 'Head':TableHeader, 'Band':'F814W', 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'AB'})
            continue
        if TableHeader == 'GALEX_NUV':
            SED.append({'Type':'MAG AB', 'Head':TableHeader, 'Band':'GALEX NUV', 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'AB'})
            continue
        if TableHeader == 'GALEX_dNUV':
            SED.append({'Type':'MAG ERROR', 'Head':TableHeader, 'Band':'GALEX NUV', 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'AB'})
            continue
        if TableHeader == 'GALEX_FUV':
            SED.append({'Type':'MAG AB', 'Head':TableHeader, 'Band':'GALEX FUV', 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'AB'})
            continue
        if TableHeader == 'GALEX_dFUV':
            SED.append({'Type':'MAG ERROR', 'Head':TableHeader, 'Band':'GALEX FUV', 'Wave':numpy.nan, 'Flux':numpy.nan, 'Flux Error':numpy.nan, 'WaveUnit':'um', 'FluxUnit':'AB'})
            continue
        # 
        # FLUX (f24um)
        ...
        for i in range(len(sys.argv)-2):
            ...
            for j in range(len(SourceID_Match)):
                ...
                for k in range(len(SED)):
                    ...
                    if math.isnan(FilterWave):
                        FilterName, FilterWave = recognize_Filter(FilterBand)
