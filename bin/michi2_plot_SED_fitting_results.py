...
if len(sys.argv) <= 1:
    ...
    if 'value' in Stellar_age_dict:
        analyze_chisq_distribution(Stellar_age_dict, Plot_engine = Plot_engine)
    if 'value' in Stellar_EBV_dict:
        analyze_chisq_distribution(Stellar_EBV_dict, Plot_engine = Plot_engine)
    ...
    if 'value' in dust_emissivity_beta_dict:
        analyze_chisq_distribution(dust_emissivity_beta_dict, Plot_engine = Plot_engine)
    if 'value' in dust_temperature_dict:
        analyze_chisq_distribution(dust_temperature_dict, Plot_engine = Plot_engine)
