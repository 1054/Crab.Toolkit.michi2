...
def recognize_Filter_Instrument_by_Short_Name(input_str, catalog_name = ''):
    ...
    if type(catalog_name) is str:
        ...
        if catalog_name.find('Skelton2014')>=0 or catalog_name.upper().find('3DHST')>=0:
            ...
            if catalog_name.upper().find('COSMOS')>=0 or catalog_name.upper().find('AEGIS')>=0:
                ...
                Filter_Dict['j1'] = 'KPNO NEWFIRM J1' # Skelton 2014ApJS..214...24S Table 3, 5
                Filter_Dict['j2'] = 'KPNO NEWFIRM J2' # Skelton 2014ApJS..214...24S Table 3, 5
                Filter_Dict['j3'] = 'KPNO NEWFIRM J3' # Skelton 2014ApJS..214...24S Table 3, 5
                Filter_Dict['h1'] = 'KPNO NEWFIRM H1' # Skelton 2014ApJS..214...24S Table 3, 5
                Filter_Dict['h2'] = 'KPNO NEWFIRM H2' # Skelton 2014ApJS..214...24S Table 3, 5
                Filter_Dict['k'] = 'KPNO NEWFIRM K' # Skelton 2014ApJS..214...24S Table 3, 5
                ...
                Filter_Dict['ks'] = 'CFHT WIRCAM K' # Skelton 2014ApJS..214...24S Table 3, 5
        ...
        if catalog_name.find('Straatman2016')>=0:
            ...
            Filter_Dict['CFHTMegaCamU'] = 'CFHT MegaCam U' # Straatman+2016 Sect. 2.4, for UDS
            Filter_Dict['SubaruSurpimeCamR'] = 'Subaru SuprimeCam R' # Straatman+2016 Sect. 2.4, for UDS
            Filter_Dict['SubaruSurpimeCamB'] = 'Subaru SuprimeCam B' # Straatman+2016 Sect. 2.4, for UDS
            Filter_Dict['SubaruSurpimeCamV'] = 'Subaru SuprimeCam V' # Straatman+2016 Sect. 2.4, for UDS
            Filter_Dict['SubaruSurpimeCamI'] = 'Subaru SuprimeCam I' # Straatman+2016 Sect. 2.4, for UDS
            Filter_Dict['SubaruSurpimeCamZ'] = 'Subaru SuprimeCam Z' # Straatman+2016 Sect. 2.4, for UDS
            Filter_Dict['Y'] = 'VLT HAWKI Y' # Straatman+2016 Sect. 2.4, for UDS, Fontana et al. 2014
            Filter_Dict['J'] = 'UKIRT WFCAM J' # Straatman+2016 Sect. 2.4, for UDS, O. Almaini 2016, in preparation
            Filter_Dict['H'] = 'UKIRT WFCAM H' # Straatman+2016 Sect. 2.4, for UDS, O. Almaini 2016, in preparation
            Filter_Dict['K'] = 'UKIRT WFCAM K' # Straatman+2016 Sect. 2.4, for UDS, O. Almaini 2016, in preparation
    ...
    if type(catalog_name) is str:
        if catalog_name.find('Skelton2014')>=0 or catalog_name.upper().find('3DHST')>=0:
            ...
            if catalog_name.upper().find('COSMOS')>=0 or catalog_name.upper().find('AEGIS')>=0:
                ...
                Filter_Dict['j1'] = 1.0460 # Skelton 2014ApJS..214...24S Table 3, 5
                Filter_Dict['j2'] = 1.1946 # Skelton 2014ApJS..214...24S Table 3, 5
                Filter_Dict['j3'] = 1.2778 # Skelton 2014ApJS..214...24S Table 3, 5
                Filter_Dict['h1'] = 1.5601 # Skelton 2014ApJS..214...24S Table 3, 5
                Filter_Dict['h2'] = 1.7064 # Skelton 2014ApJS..214...24S Table 3, 5
                ...
                Filter_Dict['ks'] = 2.1574 # Skelton 2014ApJS..214...24S Table 3, 5
        ...
        if catalog_name.find('Straatman2016')>=0:
            ...
            Filter_Dict['CFHTMegaCamU'] = 0.3828 # Straatman+2016 Table 4 for UDS
            Filter_Dict['SubaruSurpimeCamR'] = 0.6508 # Straatman+2016 Table 4 for UDS
            Filter_Dict['SubaruSurpimeCamB'] = 0.4408 # Straatman+2016 Table 4 for UDS
            Filter_Dict['SubaruSurpimeCamV'] = 0.5470 # Straatman+2016 Table 4 for UDS
            Filter_Dict['SubaruSurpimeCamI'] = 0.7656 # Straatman+2016 Table 4 for UDS
            Filter_Dict['SubaruSurpimeCamZ'] = 0.9060 # Straatman+2016 Table 4 for UDS
            Filter_Dict['Y'] = 1.0207 # Straatman+2016 Table 4 for UDS, Fontana et al. 2014
            Filter_Dict['J'] = 1.2502 # Straatman+2016 Table 4 for UDS, O. Almaini 2016, in preparation
            Filter_Dict['H'] = 1.6360 # Straatman+2016 Table 4 for UDS, O. Almaini 2016, in preparation
            Filter_Dict['K'] = 2.2060 # Straatman+2016 Table 4 for UDS, O. Almaini 2016, in preparation
