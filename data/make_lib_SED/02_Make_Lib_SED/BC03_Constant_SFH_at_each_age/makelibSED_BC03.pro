...
PRO makelibSED_BC03, age_Myr
    ...
    FOREACH specfile, speclist DO BEGIN
        ...
        age = age_Myr*1e6 / 1e9 ; Gyr
        
        ; the BC03 CSP is constant SFH of 1 Msun/yr, age is age_Myr, mass loss is <TODO> assumed to be 1.0 (no mass loss)
